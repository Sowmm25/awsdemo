...
import com.example.S13SpringBootREST.repository.AdminCategoryRepository;
import com.example.S13SpringBootREST.repository.AdminShoesRepository;
...
public class Shoes {
	...
	public String shoesInsert(@RequestParam("name") String name,@RequestParam("price") double price,@RequestParam("category") String category,ModelMap model) {
		Shoe shoes = new Shoe();
		shoes.setName(name);
	...
	public String updateShoes(@RequestParam("name") String name,@RequestParam("price") double price,@RequestParam("category") String category, HttpServletRequest request, ModelMap model) {
		HttpSession usersession = request.getSession();
